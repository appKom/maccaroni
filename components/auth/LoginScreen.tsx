...
export default function LoginScreen() {
  ...
  return (
    <div className="flex flex-1 py-16 flex-col items-center justify-center mt-24 w-full bg-gradient-to-br from-emerald-950 to-slate-900 relative overflow-hidden">
      {mounted && (
        <>
